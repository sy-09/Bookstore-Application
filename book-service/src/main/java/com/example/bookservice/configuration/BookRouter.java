		...
		return RouterFunctions.route()
				.nest(RequestPredicates.path(Constants.ENDPOINT_VERSION),
					builder -> {
						...
						.GET(Constants.BOOK_ENDPOINT+"/find/bookname/{bookName}",request -> bookHandler.findByBookName(request))
						.GET(Constants.BOOK_ENDPOINT+"/find/authorname/{authorName}",bookHandler::findByAuthorName)
						.GET(Constants.BOOK_ENDPOINT+"/find/isbn/{isbn}",bookHandler::findByIsbn)
